...
# five options provided by https://cloud.google.com/solutions/creating-object-detection-application-tensorflow
# we pick four of them since the third one looks quite similar to the fourth one.
# mAP 21; fast
...
i = 0
test_annos = dict()
TEST_IMAGE_PATHS = ['./test_image.png']
for image_path in TEST_IMAGE_PATHS:
    ...
    test_annos[i] = {'objects': get_results(
